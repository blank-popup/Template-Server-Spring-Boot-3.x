...
@AllArgsConstructor
@NoArgsConstructor
public class EndpointEntity extends AuditableCU {
    ...
    public EndpointEntity(String name, String method, String path, String parameter, String tenantBelong, String tenantName) {
        this.name = name;
        this.method = method;
        this.path = path;
    ...
    public EndpointEntity(String name, String method, String path, String parameter) {
        this.name = name;
        this.method = method;
        this.path = path;
        this.parameter = parameter;
